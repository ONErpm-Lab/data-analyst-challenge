...
year_over_year_monthly_revenue_by_store as (
    select
        current_month.store,
    ...
    from monthly_revenue_by_store as current_month

    left join monthly_revenue_by_store as prior_month
        on current_month.date_of_event = prior_month.date_of_event + interval '1 year'
        and current_month.store = prior_month.store
...
final as (
    ...
    from year_over_year_monthly_revenue_by_store
)
